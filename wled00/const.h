...
#define TYPE_GOVEE_BULB_CCT      27            //govee_bulb_CCT: alternating GRB + CCT chips (2 ICs per logical pixel)
#define TYPE_GOVEE_BULB_WW       28            //govee_bulb_WW : alternating GRB + WW chips (2 ICs per logical pixel)
